...
Since the source code must be in sync with the policy definition configurations, make sure you've at least run `make build-asset-files` once before compiling.
